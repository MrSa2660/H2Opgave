...
public class Menu
{
    ...
    private void VisReservationDetaljer(Reservation reservation)
    {
        ...
        Console.WriteLine($"Pris: {reservation.Pris}");
    ...
    private async Task OpretNytOmråde()
    {
        ...
        nytOmråde.Navn = Console.ReadLine();
        if (string.IsNullOrWhiteSpace(nytOmråde.Navn))
        {
    ...
    private async Task RedigerOmråde()
    {
        ...
        try
        {
            ...
            Console.Write($"Nyt navn ({område.Navn}): ");
    ...
    private async Task VisOmrådeStatistik()
    {
        ...
        try
        {
            ...
            Console.WriteLine($"\nStatistik for område: {område.Navn}");
    ...
    private async Task OpretNySæsonkategori()
    {
        ...
        nySæson.Navn = Console.ReadLine().ToLower();
        if(nySæson.Navn == null) {

            Console.WriteLine("Tom kategori.");
            return;
        }
       
        Console.WriteLine("\nIndtast ugenumre (1-52, adskilt af komma):");
        nySæson.Uger = Console.ReadLine();
        if (nySæson.Uger == null) {

            Console.WriteLine("indtast uge");
            Console.ReadKey();
            return;
        }
        ...
        nySæson.Pris = multiplikator;

        try
        {
            SæsonKategori.DatabaseHelper.CreateSæsonKategori(nySæson);
            Console.WriteLine($"\nSæsonkategori oprettet med ID: {nySæson.GetKategoriId()}!");
            Console.ReadKey();
        }
        catch (Exception ex)
        {
    ...
    private async Task VisAlleSæsonkategorier()
    {
        ...
        try
        {
            var kategorier = SæsonKategori.DatabaseHelper.ReadAllSæsonKategorier();
    ...
    private async Task SøgSæsonkategori()
    {
        ...
        if (int.TryParse(Console.ReadLine(), out int kategoriId))
        {
            try
            {
                var kategori = SæsonKategori.DatabaseHelper.ReadSæsonKategoriById(kategoriId);
                if (kategori != null)
                {
    ...
    private async Task RedigerSæsonkategori()
    {
        ...
        try
        {
            ...
            Console.Write($"Ny kategori ({kategori.Navn}): ");
            string nyKategori = Console.ReadLine().ToLower();
            if (!string.IsNullOrWhiteSpace(nyKategori))
            {
                kategori.Navn = nyKategori;
            }

            Console.Write($"Ny prismultiplikator ({kategori.Pris}): ");
            ...
            if (!string.IsNullOrWhiteSpace(nyMultiplikator) && int.TryParse(nyMultiplikator, out int multiplikator))
                kategori.Pris = multiplikator;

            Console.Write($"Nye ugenumre ({kategori.Uger}): ");
            string nyeUgenumre = Console.ReadLine();
            if (!string.IsNullOrWhiteSpace(nyeUgenumre))
            {
               kategori.Uger = nyeUgenumre;
            }

            SæsonKategori.DatabaseHelper.UpdateSæsonKategori(kategori);
    ...
    private async Task SletSæsonkategori()
    {
        ...
        if (int.TryParse(Console.ReadLine(), out int kategoriId))
        {
            try
            {
                ...
                if (Console.ReadLine().ToLower() == "ja")
                {
                    SæsonKategori.DatabaseHelper.DeleteSæsonKategori(kategoriId);
    ...
    private async Task VisSæsonkategoriPriser()
    {
        ...
        try
        {
            ...
            Console.WriteLine($"\nPriser for {kategori.Navn}-sæson (multiplikator: {kategori.Pris}%):");
    ...
    {
        Console.WriteLine($"Sæsonkategori ID: {kategori.GetKategoriId()}");
        Console.WriteLine($"Kategori: {kategori.Navn}");
        Console.WriteLine($"Prismultiplikator: {kategori.Pris}%");
        Console.WriteLine($"Ugenumre: {kategori.Uger}");
    }
    #endregion
    ...
    private async Task OpretNyEjer()
    {
        ...
        try
        {
            Ejer.DatabaseHelper.CreateEjer(ejer);
    ...
    private async Task VisAlleEjere()
    {
        ...
        try
        {
            var ejere = Ejer.DatabaseHelper.ReadAllEjere();
    ...
    private async Task SøgEjer()
    {
        ...
        if (int.TryParse(Console.ReadLine(), out int ejerId))
        {
            try
            {
                var ejer = Ejer.DatabaseHelper.ReadEjerById(ejerId);
                if (ejer != null)
                {
                    Console.WriteLine($"\nID: {ejer.GetEjerId()}");
        ...
        if (int.TryParse(Console.ReadLine(), out int ejerId))
        {
            try
            {
                ...
                if (ejer != null)
                {
                    ...
                    Ejer.DatabaseHelper.UpdateEjer(ejer);
        ...
        if (int.TryParse(Console.ReadLine(), out int ejerId))
        {
            try
            {
                ...
                if (ejer != null)
                {
                    ...
                    {
                        Ejer.DatabaseHelper.DeleteEjer(ejerId);
    ...
    private async Task VisEjersSommerhuse()
    {
        ...
        if (int.TryParse(Console.ReadLine(), out int ejerId))
        {
            var ejersSommerhuse = Ejer.DatabaseHelper.ReadEjersSommerhuse(ejerId);
            VisPaginering(ejersSommerhuse, VisSommerhusDetaljer, "ejers sommerhuse");
        }
    ...
    private async Task OpretNyKunde()
    {
        ...
        try
        {
            Kunde.DatabaseHelper.CreateKunde(kunde);
    ...
    private async Task VisAlleKunder()
    {
        ...
        try
        {
            var kunder = Kunde.DatabaseHelper.ReadAllKunde();
            VisPaginering(kunder, VisKundeDetaljer, "kunde");
        }
        catch (Exception ex)
        {
    ...
    private async Task SøgKunde()
    {
        ...
        if (int.TryParse(Console.ReadLine(), out int kundeId))
        {
            try
            {
                var kunde = Kunde.DatabaseHelper.ReadKundeById(kundeId);
                if (kunde != null)
                {
    ...
    private async Task RedigerKunde()
    {
        ...
        try
        {
            ...
            Kunde.DatabaseHelper.UpdateKunde(kunde);
    ...
    private async Task SletKunde()
    {
        ...
        try
        {
            ...
            if (Console.ReadLine().ToLower() == "ja")
            {
                Kunde.DatabaseHelper.DeleteKunde(kundeId);
    ...
    private void VisKundeDetaljer(Kunde kunde)
    {
        ...
        Console.WriteLine($"Telefon: {kunde.Tlfnr}");
    ...
    private async Task OpretNyOpsynsmand()
    {
        ...
        Console.Write("(inspektor/opsynsmand): ");
        string Rolle = Console.ReadLine().ToLower();
        if(Rolle != "inspektor" && Rolle != "opsynsmand") {
        ...
        try
        {
            Opsynsmand.CreateOpsynsmand(opsynsmand);
            Console.WriteLine($"\nOpsynsmand oprettet!");
            Console.ReadKey();
        }
        catch (Exception ex)
    ...
    private async Task VisAlleOpsynsmænd()
    {
        ...
        try
        {
            var opsynsmænd = Opsynsmand.ReadAllOpsynsmænd();
    ...
    private async Task SøgOpsynsmand()
    {
        ...
        if (int.TryParse(Console.ReadLine(), out int opsynsmandId))
        {
            try
            {
                var opsynsmand = Opsynsmand.ReadOpsynsmandById(opsynsmandId);
                if (opsynsmand != null)
                {
    ...
    private async Task RedigerOpsynsmand()
    {
        ...
        try
        {
            ...
            Opsynsmand.UpdateOpsynsmand(opsynsmand);
    ...
    private async Task SletOpsynsmand()
    {
        ...
        try
        {
            ...
            if (Console.ReadLine().ToLower() == "ja")
            {
                Opsynsmand.DeleteOpsynsmand(opsynsmandId);
    ...
    private void VisOpsynsmandDetaljer(Opsynsmand opsynsmand)
    {
    ...
    private async Task OpretNyKonsulent()
    {
        ...
        string email = Console.ReadLine();
        if (email == "") {
            Console.WriteLine("Ugyldigt Email!");
            Console.ReadKey();
            return;
        }
        ...
        string telefon = Console.ReadLine();
        if (telefon == "") {
            Console.WriteLine("Ugyldigt telefon nummer!");
            Console.ReadKey();
            return;
        }
        ...
        string adresse = Console.ReadLine();
        if (adresse == null) {
            Console.WriteLine("Ugyldigt adresse!");
            Console.ReadKey();
            return;
        }
